...
desired_WeiChat={
  ...
  "platformVersion": "5.0",
  "deviceName": "GIEQM7DIZTAYY98L",
  "appPackage": "com.lenovo.coverapp.simpletime2",
  "appActivity": "com.lenovo.coverapp.simpletime.MainActivity"
}
driver = webdriver.Remote("http://localhost:4723/wd/hub",desired_WeiChat)
# 等待时间
time.sleep(5)
